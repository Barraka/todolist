...
function newtask() {
    ...
    let prioritylabel2 = document.createElement('div');
    ...
    // }
    function appendtask() {
        mytasks.newTask(titleinput.value, descriptioninput.value, deadlineinput.value,priochosen,'');
        erasefields();    
    }
